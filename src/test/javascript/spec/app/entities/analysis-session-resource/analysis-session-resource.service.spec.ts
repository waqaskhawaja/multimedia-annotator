...
import { IAnalysisSessionResource, AnalysisSessionResource } from 'app/shared/model/analysis-session-resource.model';

describe('Service Tests', () => {
    describe('AnalysisSessionResource Service', () => {
        let injector: TestBed;
        let service: AnalysisSessionResourceService;
        let httpMock: HttpTestingController;
        let elemDefault: IAnalysisSessionResource;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a AnalysisSessionResource', async () => {
                ...
                service
                    .create(new AnalysisSessionResource(null))
                    .pipe(take(1))
            ...
            it('should delete a AnalysisSessionResource', async () => {
