...
describe('Service Tests', () => {
    describe('Annotation Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Annotation(0, currentDate, currentDate, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Annotation', async () => {
                const returnedFromService = Object.assign(
                    {
                        start: currentDate.format(DATE_TIME_FORMAT),
                        end: currentDate.format(DATE_TIME_FORMAT),
            ...
            it('should delete a Annotation', async () => {
