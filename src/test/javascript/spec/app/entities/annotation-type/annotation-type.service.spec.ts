...
describe('Service Tests', () => {
    describe('AnnotationType Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a AnnotationType', async () => {
            ...
            it('should update a AnnotationType', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB'
                    },
            ...
            it('should return a list of AnnotationType', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB'
                    },
            ...
            it('should delete a AnnotationType', async () => {
