...
import { ISourceDataType, SourceDataType } from 'app/shared/model/source-data-type.model';

describe('Service Tests', () => {
    describe('SourceDataType Service', () => {
        let injector: TestBed;
        let service: SourceDataTypeService;
        let httpMock: HttpTestingController;
        let elemDefault: ISourceDataType;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a SourceDataType', async () => {
                ...
                service
                    .create(new SourceDataType(null))
                    .pipe(take(1))
            ...
            it('should delete a SourceDataType', async () => {
