...
export class AnnotationTypeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.annotationTypeService
                ...
                .subscribe(
                    (res: HttpResponse<IAnnotationType[]>) => this.paginateAnnotationTypes(res.body, res.headers),
    ...
    registerChangeInAnnotationTypes() {
        this.eventSubscriber = this.eventManager.subscribe('annotationTypeListModification', response => this.loadAll());
    }
    ...
    protected paginateAnnotationTypes(data: IAnnotationType[], headers: HttpHeaders) {
