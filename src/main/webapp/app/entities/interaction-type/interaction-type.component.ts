...
export class InteractionTypeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.interactionTypeService
                ...
                .subscribe(
                    (res: HttpResponse<IInteractionType[]>) => this.paginateInteractionTypes(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/interaction-type'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateInteractionTypes(data: IInteractionType[], headers: HttpHeaders) {
