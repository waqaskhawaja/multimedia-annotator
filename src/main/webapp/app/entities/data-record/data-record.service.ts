...
export class DataRecordService {
    ...
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/data-records';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IDataRecord[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
