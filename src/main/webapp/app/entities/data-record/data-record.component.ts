...
export class DataRecordComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.dataRecordService
                ...
                .subscribe(
                    (res: HttpResponse<IDataRecord[]>) => this.paginateDataRecords(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/data-record'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateDataRecords(data: IDataRecord[], headers: HttpHeaders) {
