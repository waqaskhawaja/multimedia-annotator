...
public class Annotation implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "annotation_data_record",
    ...
    public Annotation dataRecords(Set<DataRecord> dataRecords) {
        this.dataRecords = dataRecords;
        return this;
    }

    public Annotation addDataRecord(DataRecord dataRecord) {
        this.dataRecords.add(dataRecord);
        dataRecord.getAnnotations().add(this);
        return this;
    }

    public Annotation removeDataRecord(DataRecord dataRecord) {
        this.dataRecords.remove(dataRecord);
        dataRecord.getAnnotations().remove(this);
        return this;
    }
