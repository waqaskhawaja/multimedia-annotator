...
/**
 * REST controller for managing AnalysisScenario.
 */
@RestController
@RequestMapping("/api")
public class AnalysisScenarioResource {
    ...
    /**
     * POST  /analysis-scenarios : Create a new analysisScenario.
     *
     * @param analysisScenario the analysisScenario to create
     * @return the ResponseEntity with status 201 (Created) and with body the new analysisScenario, or with status 400 (Bad Request) if the analysisScenario has already an ID
    ...
    /**
     * PUT  /analysis-scenarios : Updates an existing analysisScenario.
     *
     * @param analysisScenario the analysisScenario to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated analysisScenario,
     * or with status 400 (Bad Request) if the analysisScenario is not valid,
     * or with status 500 (Internal Server Error) if the analysisScenario couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    /**
     * GET  /analysis-scenarios : get all the analysisScenarios.
     *
     * @param pageable the pagination information
     * @param criteria the criterias which the requested entities should match
     * @return the ResponseEntity with status 200 (OK) and the list of analysisScenarios in body
     */
    ...
    public ResponseEntity<List<AnalysisScenario>> getAllAnalysisScenarios(AnalysisScenarioCriteria criteria, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/analysis-scenarios");
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }

    /**
    * GET  /analysis-scenarios/count : count all the analysisScenarios.
    *
    * @param criteria the criterias which the requested entities should match
    ...
    */
    ...
    /**
     * GET  /analysis-scenarios/:id : get the "id" analysisScenario.
     *
     * @param id the id of the analysisScenario to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the analysisScenario, or with status 404 (Not Found)
     */
    ...
    /**
     * DELETE  /analysis-scenarios/:id : delete the "id" analysisScenario.
     *
    ...
    /**
     * SEARCH  /_search/analysis-scenarios?query=:query : search for the analysisScenario corresponding
     * to the query.
     *
